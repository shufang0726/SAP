        ...
        public void GenerateTC(XmlDocument xmlDoc)
        {
            ...
            if (xmlDoc.SelectNodes("Cases/Case") != null)
            {
                ...
                for (int i = 0; i < xmlNodes.Count; i++)
                {
                    ...
                    {
                        strVersion = xmlNodeSteps[0].Attributes["version"].Value;
                        strdeviceName = xmlNodeSteps[0].Attributes["deviceName"].Value;
                        strUri = xmlNodeSteps[0].Attributes["Uri"].Value;
                        strBrowser = xmlNodeSteps[0].Attributes["Browser"].Value;                       
